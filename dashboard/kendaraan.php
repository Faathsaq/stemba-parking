<?php
// dashboard/kendaraan.php — v2 CREAM EDITION
...
$params = [$uid];
if ($filter !== 'semua') { $where .= " AND k.status = ?"; $params[] = $filter; }
if ($search !== '') {
...
<head>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    ...
    /* Palet utama */
    --bg:             #fffdf7;              /* Cream / Ivory */
    --surface:        #f5f2ea;              /* Warm Cream */
    --accent:         #536878;              /* Blue Slate */
    ...
    --yellow:         #8a6e20;
    --yellow-bg:      rgba(138,110,32,0.07);
    --yellow-bdr:     rgba(138,110,32,0.20);
    --red:            #b03a2e;
    --red-bg:         rgba(176,58,46,0.07);
    --red-bdr:        rgba(176,58,46,0.20);
  }
  ...
  .db-avatar {
    width: 34px; height: 34px; border: 1px solid var(--border-acc);
  ...
  .btn-logout:hover { border-color: var(--red-bdr); color: var(--red); background: var(--red-bg); text-decoration: none; }
  ...
  .page-title {
    font-family: var(--font-serif); font-size: clamp(26px, 3.5vw, 42px);
    font-weight: 400; color: var(--fg); letter-spacing: -0.02em; line-height: 1;
  }
  ...
  .btn-primary:hover { background: var(--accent); color: #fff; text-decoration: none; transform: translateY(-2px); }
  .btn-primary i { font-size: 10px; }
  ...
  .stat-strip-item:hover::before,
  .stat-strip-item.active::before  { opacity: 1; }
  .stat-strip-item:hover           { background: rgba(83,104,120,0.04); }
  .stat-strip-item.active          { background: rgba(83,104,120,0.06); }
  ...
  .stat-strip-item:hover .ssi-icon,
  .stat-strip-item.active .ssi-icon { transform: rotate(-6deg) scale(1.08); }
...
>>>>>>> 259f585721ac34a9cbd5c11af5e25d1d037ca953
  ...
  .ssi-label {
    ...
    text-transform: uppercase; color: var(--fg-low); margin-top: 3px; display: block;
  }
  ...
  .search-input:focus { border-color: var(--border-acc); background: #fff; }
  ...
  .filter-pill:hover { border-color: var(--border-acc); color: var(--fg); background: rgba(83,104,120,0.05); }
  ...
  .table-head {
    display: grid; grid-template-columns: 2.5fr 1.3fr 1fr 1.2fr 1.3fr 110px;
    background: var(--surface); border-bottom: 1px solid var(--border); min-width: 700px;
  }
  .th {
  ...
  .table-row {
    display: grid; grid-template-columns: 2.5fr 1.3fr 1fr 1.2fr 1.3fr 110px;
    border-bottom: 1px solid var(--border); min-width: 700px;
    position: relative; transition: background 0.18s; background: var(--bg);
  }
  ...
  .table-row:hover { background: rgba(83,104,120,0.04); }
  ...
  .page-btn:hover { border-color: var(--border-acc); color: var(--fg); background: rgba(83,104,120,0.05); }
  ...
  @media (prefers-reduced-motion: reduce) {
    .btn-primary:hover,
    .stat-strip-item.active .ssi-icon { transform: none !important; }
  }
  </style>
</head>
<body>
...
<main class="page">
  ...
  <div class="toolbar" data-aos="fade-up" data-aos-delay="100" data-aos-duration="600">
    ...
    <div class="filter-pills">
      ...
      ?>
      <a href="<?= $url ?>" class="filter-pill <?= $is_active ? $p['cls'] : '' ?>">
  ...
  <div class="pagination" data-aos="fade-up" data-aos-duration="500">
    ...
    <div class="pagination-btns">
      <?php $base_url = '?status=' . urlencode($filter) . ($search ? '&q='.urlencode($search) : ''); ?>
