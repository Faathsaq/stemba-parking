<?php
// sections/hero.php — v2 AMBER EDITORIAL
// FRAGMENT: jangan tambahkan <html>, <head>, atau <body> di file ini.
// Hero Section — Stemba Parking · SMKN 7 Semarang
// Konsep: Editorial Magazine · Dark + Amber · Hero Page
...
/* ============================================================
   HERO — EDITORIAL · DARK + AMBER · MAGAZINE HERO
   ============================================================ */
...
:root {
  ...
  --hr-accent:     #f59e0b;
  --hr-accent-dim: rgba(245,158,11,0.18);
  --hr-accent-glow:rgba(245,158,11,0.07);
  --hr-bg:         #0d0d0d;
  --hr-fg:         #ffffff;
  --hr-fg-mid:     rgba(255,255,255,0.52);
  --hr-fg-low:     rgba(255,255,255,0.22);
  --hr-border:     rgba(255,255,255,0.08);
  --hr-border-acc: rgba(245,158,11,0.32);
}
...
.hr-live-badge {
  ...
  border: 1px solid rgba(134,239,172,0.2); border-radius: 3px;
  background: rgba(134,239,172,0.06);
}
.hr-live-dot {
  width: 5px; height: 5px; border-radius: 50%; background: #86efac;
...
.hr-title .hr-t-dim    { color: rgba(255,255,255,0.22); }
...
.btn-hr-amber {
  ...
  background: var(--hr-accent); color: #0d0d0d;
...
.btn-hr-amber i { transition: transform 0.22s; font-size: 12px; }
.btn-hr-amber:hover i { transform: translateX(4px); }

.btn-hr-ghost {
  display: inline-flex; align-items: center; gap: 8px;
  background: transparent; color: var(--hr-fg-mid);
...
.btn-hr-ghost:hover {
  border-color: var(--hr-border-acc); color: var(--hr-accent);
  background: var(--hr-accent-glow); text-decoration: none;
}
.btn-hr-ghost i { font-size: 11px; }

/* bottom stat strip inside left col */
.hr-stat-strip {
  display: flex; gap: 0;
...
.hr-vcard:hover { background: rgba(255,255,255,0.045); border-color: rgba(255,255,255,0.13); transform: translateX(4px); }
...
.hr-vcard-type { font-size: 13px; font-weight: 700; color: rgba(255,255,255,0.88); line-height: 1.2; }
.hr-vcard-plat {
...
.hb-ok   { background: rgba(134,239,172,0.1); color: #86efac; border-color: rgba(134,239,172,0.2); }
.hb-wait { background: rgba(245,158,11,0.1);  color: var(--hr-accent); border-color: var(--hr-border-acc); }
.hb-rev  { background: rgba(255,255,255,0.06); color: var(--hr-fg-low); border-color: var(--hr-border); }
...
.hr-prog-fill {
  height: 100%;
  background: linear-gradient(90deg, #d97706, var(--hr-accent), #fde68a);
...
/* info card */
.hr-info-card {
  background: rgba(255,255,255,0.02); border: 1px solid var(--hr-border); padding: 16px 20px;
...
.hr-bottom-cell:hover { background: rgba(255,255,255,0.02); }
...
@media (prefers-reduced-motion: reduce) {
  ...
  .hr-vcard:hover, .btn-hr-amber:hover, .btn-hr-ghost:hover { transform: none !important; }
...
<section class="hr-hero" id="beranda" aria-label="Beranda — Stemba Parking SMKN 7 Semarang">
  ...
  <div class="container" style="position:relative;z-index:10;flex:1;display:flex;flex-direction:column;">
    ...
    <!-- ── META BAR ─────────────────────────────────────────── -->
    <div class="hr-meta-bar" data-aos="fade-down" data-aos-duration="500">
      <div class="hr-meta-left">
        <span class="hr-meta-tag">Stemba Parking</span>
        <span class="hr-meta-sep" aria-hidden="true"></span>
        <span class="hr-meta-txt">Sistem Pendataan Kendaraan Siswa &nbsp;·&nbsp; SMKN 7 Semarang</span>
      </div>
    ...
    <div class="hr-main">
      ...
      <div class="hr-col-left">
        <div>
          <span class="hr-overline"
                data-aos="fade-up" data-aos-duration="500">
            Sistem Pendataan Kendaraan &nbsp;—&nbsp; Edisi 2026
          </span>

          <h1 class="hr-title"
              data-aos="fade-up" data-aos-delay="60" data-aos-duration="800">
            Parkir<br>
          ...
          <p class="hr-desc"
             data-aos="fade-up" data-aos-delay="130" data-aos-duration="700">
          ...
          <div class="hr-actions"
               data-aos="fade-up" data-aos-delay="220" data-aos-duration="700">
            <a class="btn-hr-amber" href="dashboard/kendaraan.php">
              Daftar Kendaraan
              <i class="fa-solid fa-arrow-right" aria-hidden="true"></i>
            </a>
            <a class="btn-hr-ghost" href="dashboard/dashboard-user.php">
    ...
    <div class="container">
      <div class="hr-bottom-inner">
        <div class="hr-bottom-cell">
          ...
          <span class="hr-bottom-cell-num"><span class="cell-acc">Cepat</span> &amp; Mudah</span>
